...
| 5   | Server code in client bundle | `pages/providers/gog/index.vue` imports `server/providers/gog/api.ts` (client secret, fetch code). Secret is the public launcher one, but the boundary is missing.                                                                                                                             | [04](04-Server-Only-Provider-Code.md)   |
